...
c
      open(file='ru77n1',unit=39,status='old')
...
c     write(6,*) tr1,tr2,sum1r,sum2r
           write(iw,132) time,sum1o,sum2o
 132       format(f8.2,2f8.3)
c          write(iw,131) time,sumnt,sumntt,sumbnt,
c    c          sum1r,sum1b,sum1b2,sum1d1,sum1d2,sum1ds,sum1o,
c    c          sum2r,sum2b,sum2b2,sum2d1,sum2d2,sum2ds,sum2o
