     ...
     c   ar1(nux),a2r1(nux),a2r1s(nux),
     c   ar2(nux),a2r2(nux),a2d2(nux),a2rstar2(nux),
     c   ad1(nux),a2d1(nux),a2d1s(nux),
...
c
      open(file='inputfilesl', unit=39,status='old')
...
c
      ...
      iu=34
      inul=33
      open(unit=inul,status='unknown',file='nulfilel')
...
c     write(6,*) tr1,tr2,sum1r,sum2r
     ...
     c          sum2r,sum2b,sum2b2,sum2d,sum2o
...
c
c23456789012345678901234567890123456789012345678901234567890123456789012
          R(i) = r2t(i)-ar2(i)-a2r2(i)-a2d2(i)-a2rstar2(i)
c
	    dar2 = dtt*( u(i)*R(i) * ratecons1
     c		       + a2r2(i) * ratecons4
     c		       - ar2(i)*(u(i)*ratecons2+ ratecons3))
c
	    da2r2 = dtt*(u(i)*ar2(i)*ratecons3
     c                  + a2rstar2(i)*ratecons6
     c			+ a2d2(i)*ratecons8
     c			- a2r2(i)*(ratecons4+ratecons7+ratecons5))
c
	    da2rstar2 = dtt*(a2r2(i)*ratecons5 - a2rstar2(i)*ratecons6)
c
            da2d2 = dtt*(a2r2(i)*ratecons7 - a2d2(i)*ratecons8)
c
	    par2 = ar2(i) + dar2
	    pa2r2 = a2r2(i) + da2r2
	    pa2rstar2 = a2rstar2(i) + da2rstar2
	    pa2d2 = a2d2(i) + da2d2
c
c
            pR(i) = r2t(i)-par2-pa2r2-pa2star2-pa2d2
c
	    ddar2 = dtt*( u(i)*pR(i)*ratecons1
     c		        + pa2r2 * ratecons4
     c			-pa2r2*(u(i)*ratecons2+ratecons3))
c         
	    dda2r2 = dtt*(u(i) * par2 * ratecons3
     c			 + pa2rstar2 * ratecons6
     c			 + pa2d2 * ratecons8
     c			 - pa2r2*(ratecons4+ratecons7+ratecons5))
c
	    dda2rstar2 = dtt*(pa2r2*ratecons5 - pa2rstar2*ratecons6)
c
	    dda2d2 = dtt*(pa2r2*ratecons7 - pa2rstar2*ratecons8)
c
	    ar2(i)=ar2(i)+0.5*(dar2+ddar2)
	    a2r2(i)=a2r2(i)+0.5*(da2r2+dda2r2)
	    a2rstar2(i)=a2rstar2(i)+0.5*(da2rstar2+dda2rstar2)
	    a2d2(i)=a2d2(i)+0.5*(da2d2+dda2d2)
cccccccc
c
c23456789012345678901234567890123456789012345678901234567890123456789012
       r1(i)=r1t(i)-ar1(i)-a2r1(i)-a2r1s(i)-ad1(i)-a2d1(i)-a2d1s(i)
c
       r2(i)=r2t(i)-ar2(i)-a2r2(i)-a2rstar2(i)-a2d2(i)
...
c
     ...
     c      akon(1)*r1(1)+ratecons1*r2(1)+
     c      akon2(1)*ar1(1)+ratecons3*ar2(1)+
     c      akon3(1)*ad1(1))
         cc(1)=-2.d0*dr2
     ...
     c          akon3(1)*ad1(1)))*u(1) -
     c        cc(1)*u(2)+
     c        akoff(1)*ar1(1)+ratecons2*ar2(1)+
     c        akoff2(1)*a2r1(1)+ratecons4*a2r2(1)+
     c        akoff3(1)*a2d1(1)
...
c
     ...
     c         ratecons1*r2(i)+akon2(1)*ar1(i)+ratecons3*ar2(i)+
     c         akon3(1)*ad1(i))
            cc(i)  =-dr2*0.5d0*(0.5d0/fi+1.d0)
            r(i)  =-a(i)*u(i-1)+
     c              (brc(i)+0.5d0*(ak*ub(i)-
     c          akon(1)*r1(i)-ratecons1*r2(i)-
     c          akon2(1)*ar1(i)-ratecons3*ar2(i)-
     c          akon3(1)*ad1(i)))*u(i)-
     c              cc(i)*u(i+1)+
     c        akoff(1)*ar1(i)+ratecons2*ar2(i)+
     c        akoff2(1)*a2r1(i)+ratecons4*a2r2(i)+
     c        akoff3(1)*a2d1(i)
...
c             write(inul,*) ' tdif= ',tdif
	      ...
	      sum2b=sum2b+ar2(i)*clefth*602.d0*area(i)
	      sum2b2=sum2b2+a2r2(i)*clefth*602.d0*area(i)
	      sum2d=sum2d+a2d2(i)*clefth*602.d0*area(i)
	      sum2o=sum2o+a2rstar2(i)*clefth*602.d0*area(i)
 2000      continue
c                write(6,86) i,a(n),b(n),cc(n),r(n)
           zumnt=0.d0
...
c    c         sum1b,sum2b,sum1o,sum2o
     ...
     c          sum1r,sum1b,sum1b2,sum1d1,sum1d2,sum1ds,sum1o,
     c          sum2r,sum2b,sum2b2,sum2d,sum2o
 131       format(f9.4,3f9.2,3f9.3,4f8.3,3f9.3,2f8.3)
c23456789012345678901234567890123456789012345678901234567890123456789012
